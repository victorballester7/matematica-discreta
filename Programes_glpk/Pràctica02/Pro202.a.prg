...
Minimize
 distanciaTotal: + 5 estudiantsInstituts(A,b)
 + 8 estudiantsInstituts(A,c) + 6 estudiantsInstituts(A,e)
 + 4 estudiantsInstituts(B,c) + 12 estudiantsInstituts(B,e)
 + 4 estudiantsInstituts(C,b) + 7 estudiantsInstituts(C,e)
 + 7 estudiantsInstituts(D,b) + 2 estudiantsInstituts(D,c)
 + 5 estudiantsInstituts(D,e) + 12 estudiantsInstituts(E,b)
 + 7 estudiantsInstituts(E,c)
